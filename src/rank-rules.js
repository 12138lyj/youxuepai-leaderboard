(function attachRankRules(root, factory) {
  ...
  // The coach-defined cumulative thresholds unlock each rank; 王者 is the cap.
  const ranks = [
    ...
    { name: '尊贵铂金', shortName: '铂金', minimum: 1000, color: '#4D9A8A', className: 'platinum' },
    { name: '永恒钻石', shortName: '钻石', minimum: 1600, color: '#6B86D7', className: 'diamond' },
    { name: '至尊星耀', shortName: '星耀', minimum: 2200, color: '#7D63C8', className: 'star' },
    { name: '最强王者', shortName: '王者', minimum: 3000, color: '#C68C12', className: 'king' },
  ];
